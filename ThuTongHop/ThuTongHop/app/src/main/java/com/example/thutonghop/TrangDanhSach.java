...
public class TrangDanhSach extends AppCompatActivity {
   ...
   DienThoaiAdapter adapter;
    ...
    private void AnhXa () {
        ...
        arrayDienthoai.add(new DienThoai("Thái Trần Duy Hoàng", "07/12/2002", R.drawable.iphone11));
        arrayDienthoai.add(new DienThoai("Trần Phước Lục", "08/10/2003", R.drawable.iphone9));
        arrayDienthoai.add(new DienThoai("Trần Viết Thịnh", "06/12/2005", R.drawable.iphone8));
        arrayDienthoai.add(new DienThoai("Trần Viết Ý", "08/05/2005", R.drawable.iphone12));
